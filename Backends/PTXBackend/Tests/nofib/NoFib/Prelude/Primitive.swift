...
// swiftformat:disable wrap wrapSingleLineComments blankLinesBetweenScopes
...
// @inline(never)
private func prop_eq<T: Arbitrary & Equatable>(_: T.Type) {
...
// @inline(never)
private func prop_neq<T: Arbitrary & Equatable>(_: T.Type) {
    property(String(describing: T.self) + ".!=") <-
      forAllNoShrink([T].arbitrary) { (xs: [T]) in
      forAllNoShrink([T].arbitrary) { (ys: [T]) in
        let expected = zip(xs, ys).map { x, y in x != y }
...
// @inline(never)
private func prop_lt<T: Arbitrary & Comparable>(_: T.Type) {
    property(String(describing: T.self) + ".<") <-
      forAllNoShrink([T].arbitrary) { (xs: [T]) in
      forAllNoShrink([T].arbitrary) { (ys: [T]) in
        let expected = zip(xs, ys).map { x, y in x < y }
...
// @inline(never)
private func prop_gt<T: Arbitrary & Comparable>(_: T.Type) {
    property(String(describing: T.self) + ".>") <-
      forAllNoShrink([T].arbitrary) { (xs: [T]) in
      forAllNoShrink([T].arbitrary) { (ys: [T]) in
        let expected = zip(xs, ys).map { x, y in x > y }
...
// @inline(never)
private func prop_lte<T: Arbitrary & Comparable>(_: T.Type) {
    property(String(describing: T.self) + ".<=") <-
      forAllNoShrink([T].arbitrary) { (xs: [T]) in
      forAllNoShrink([T].arbitrary) { (ys: [T]) in
        let expected = zip(xs, ys).map { x, y in x <= y }
...
// @inline(never)
private func prop_gte<T: Arbitrary & Comparable>(_: T.Type) {
    property(String(describing: T.self) + ".>=") <-
      forAllNoShrink([T].arbitrary) { (xs: [T]) in
      forAllNoShrink([T].arbitrary) { (ys: [T]) in
        let expected = zip(xs, ys).map { x, y in x >= y }
...
// @inline(never)
private func prop_min<T: Arbitrary & Comparable>(_: T.Type) {
    property(String(describing: T.self) + ".>=") <-
      forAllNoShrink([T].arbitrary) { (xs: [T]) in
      forAllNoShrink([T].arbitrary) { (ys: [T]) in
...
// @inline(never)
private func prop_max<T: Arbitrary & Comparable>(_: T.Type) {
    property(String(describing: T.self) + ".>=") <-
      forAllNoShrink([T].arbitrary) { (xs: [T]) in
      forAllNoShrink([T].arbitrary) { (ys: [T]) in
...
// @inline(never)
private func prop_negate<T: Arbitrary & SignedNumeric>(_: T.Type) {
...
// @inline(never)
private func prop_abs<T: Arbitrary & Comparable & SignedNumeric>(_: T.Type) {
...
// @inline(never)
private func prop_signum<T: Arbitrary & BinaryInteger>(_: T.Type) {
...
// @inline(never)
private func prop_plus<T: Arbitrary & AdditiveArithmetic>(_: T.Type) {
    property(String(describing: T.self) + ".+") <-
      forAllNoShrink([T].arbitrary) { (xs: [T]) in
      forAllNoShrink([T].arbitrary) { (ys: [T]) in
        let expected = zip(xs, ys).map { x, y in x + y }
...
private func prop_plus_safe<T: Arbitrary & FixedWidthInteger>(_: T.Type) {
...
// @inline(never)
private func prop_minus<T: Arbitrary & AdditiveArithmetic>(_: T.Type) {
    property(String(describing: T.self) + ".-") <-
      forAllNoShrink([T].arbitrary) { (xs: [T]) in
      forAllNoShrink([T].arbitrary) { (ys: [T]) in
        let expected = zip(xs, ys).map { x, y in x - y }
...
// @inline(never)
// Workaround for https://app.clickup.com/t/86b4gq1tv
private func prop_minus_safe<T: Arbitrary & FixedWidthInteger>(_: T.Type) {
    let gen = T.arbitrary.suchThat { (T.min / 2) <= $0 && $0 <= (T.max / 2) }
...
// @inline(never)
private func prop_mul<T: Arbitrary & Numeric>(_: T.Type) {
    property(String(describing: T.self) + ".*") <-
      forAllNoShrink([T].arbitrary) { (xs: [T]) in
      forAllNoShrink([T].arbitrary) { (ys: [T]) in
        let expected = zip(xs, ys).map { x, y in x * y }
...
// @inline(never)
// Workaround for https://app.clickup.com/t/86b4gq1tv
private func prop_mul_safe<T: Arbitrary & FixedWidthInteger>(_: T.Type) {
...
// @inline(never)
private func prop_quot<T: Arbitrary & BinaryInteger>(_: T.Type) {
...
// @inline(never)
private func prop_rem<T: Arbitrary & BinaryInteger>(_: T.Type) {
    let gen = T.arbitrary.suchThat { !($0 == 0) }
    property(String(describing: T.self) + "./") <-
      forAllNoShrink([T].arbitrary) { (xs: [T]) in
      forAllNoShrink(gen.proliferate) { (ys: [T]) in
...
// @inline(never)
private func prop_quotientAndRemainder<T: Arbitrary & BinaryInteger>(_: T.Type) {
    let gen = T.arbitrary.suchThat { !($0 == 0) }
    property(String(describing: T.self) + "./") <-
      forAllNoShrink([T].arbitrary) { (xs: [T]) in
      forAllNoShrink(gen.proliferate) { (ys: [T]) in
...
// @inline(never)
private func prop_isMultiple<T: Arbitrary & BinaryInteger>(_: T.Type) {
    property(String(describing: T.self) + "./") <-
      forAllNoShrink([T].arbitrary) { (xs: [T]) in
      forAllNoShrink([T].arbitrary) { (ys: [T]) in
...
// @inline(never)
private func prop_and<T: Arbitrary & BinaryInteger>(_: T.Type) {
    property(String(describing: T.self) + ".&") <-
      forAllNoShrink([T].arbitrary) { (xs: [T]) in
      forAllNoShrink([T].arbitrary) { (ys: [T]) in
        let expected = zip(xs, ys).map { x, y in x & y }
...
// @inline(never)
private func prop_or<T: Arbitrary & BinaryInteger>(_: T.Type) {
    property(String(describing: T.self) + ".&") <-
      forAllNoShrink([T].arbitrary) { (xs: [T]) in
      forAllNoShrink([T].arbitrary) { (ys: [T]) in
        let expected = zip(xs, ys).map { x, y in x | y }
...
// @inline(never)
private func prop_xor<T: Arbitrary & BinaryInteger>(_: T.Type) {
    property(String(describing: T.self) + ".&") <-
      forAllNoShrink([T].arbitrary) { (xs: [T]) in
      forAllNoShrink([T].arbitrary) { (ys: [T]) in
        let expected = zip(xs, ys).map { x, y in x ^ y }
...
// @inline(never)
private func prop_shiftL<T: Arbitrary & BinaryInteger>(_: T.Type) {
...
// @inline(never)
private func prop_shiftR<T: Arbitrary & BinaryInteger>(_: T.Type) {
    let gen = Gen<Int>.choose((-T.zero.bitWidth, T.zero.bitWidth))
    property(String(describing: T.self) + ".>>") <-
      forAllNoShrink([T].arbitrary) { (xs: [T]) in
      forAllNoShrink(gen.proliferate) { (ys: [Int]) in
...
// @inline(never)
private func prop_complement<T: Arbitrary & BinaryInteger>(_: T.Type) {
...
// @inline(never)
private func prop_trailingZeroBitCount<T: Arbitrary & BinaryInteger>(_: T.Type) {
...
// @inline(never)
private func prop_leadingZeroBitCount<T: Arbitrary & FixedWidthInteger>(_: T.Type) {
...
// @inline(never)
private func prop_nonzeroBitCount<T: Arbitrary & FixedWidthInteger>(_: T.Type) {
...
// @inline(never)
private func prop_byteSwapped<T: Arbitrary & FixedWidthInteger>(_: T.Type) {
...
// @inline(never)
private func prop_littleEndian<T: Arbitrary & FixedWidthInteger>(_: T.Type) {
...
// @inline(never)
private func prop_bigEndian<T: Arbitrary & FixedWidthInteger>(_: T.Type) {
...
// @inline(never)
private func prop_uncheckedPlus<T: Arbitrary & FixedWidthInteger>(_: T.Type) {
    property(String(describing: T.self) + ".&*") <-
      forAllNoShrink([T].arbitrary) { (xs: [T]) in
      forAllNoShrink([T].arbitrary) { (ys: [T]) in
        let expected = zip(xs, ys).map { x, y in x &+ y }
...
// @inline(never)
private func prop_uncheckedMinus<T: Arbitrary & FixedWidthInteger>(_: T.Type) {
    property(String(describing: T.self) + ".&-") <-
      forAllNoShrink([T].arbitrary) { (xs: [T]) in
      forAllNoShrink([T].arbitrary) { (ys: [T]) in
        let expected = zip(xs, ys).map { x, y in x &+ y }
...
// @inline(never)
private func prop_uncheckedMul<T: Arbitrary & FixedWidthInteger>(_: T.Type) {
    property(String(describing: T.self) + ".&*") <-
      forAllNoShrink([T].arbitrary) { (xs: [T]) in
      forAllNoShrink([T].arbitrary) { (ys: [T]) in
        let expected = zip(xs, ys).map { x, y in x &* y }
...
// @inline(never)
private func prop_uncheckedShiftL<T: Arbitrary & RandomType & FixedWidthInteger>(_: T.Type) {
...
// @inline(never)
private func prop_uncheckedShiftR<T: Arbitrary & RandomType & FixedWidthInteger>(_: T.Type) {
    let gen = Gen.choose((0, T(T.zero.bitWidth)))
    property(String(describing: T.self) + ".&>>") <-
      forAllNoShrink([T].arbitrary) { (xs: [T]) in
      forAllNoShrink(gen.proliferate) { (ys: [T]) in
...
// @inline(never)
private func prop_addingReportingOverflow<T: Arbitrary & FixedWidthInteger>(_: T.Type) {
...
// @inline(never)
private func prop_subtractingReportingOverflow<T: Arbitrary & FixedWidthInteger>(_: T.Type) {
...
// @inline(never)
private func prop_multipliedReportingOverflow<T: Arbitrary & FixedWidthInteger>(_: T.Type) {
...
// @inline(never)
private func prop_dividedReportingOverflow<T: Arbitrary & FixedWidthInteger>(_: T.Type) {
...
// @inline(never)
private func prop_remainderReportingOverflow<T: Arbitrary & FixedWidthInteger>(_: T.Type) {
...
// @inline(never)
private func prop_multipliedFullWidth<T: Arbitrary & FixedWidthInteger>(_: T.Type) {
...
// @inline(never)
private func prop_dividingFullWidth<T: Arbitrary & FixedWidthInteger>(_: T.Type)
...
// @inline(never)
private func prop_quot<T: Arbitrary & Similar & FloatingPoint>(_: T.Type) {
    let gen = T.arbitrary.suchThat { !($0 ~~~ 0) }
    property(String(describing: T.self) + "./") <-
      forAllNoShrink([T].arbitrary) { (xs: [T]) in
      forAllNoShrink(gen.proliferate) { (ys: [T]) in
...
// @inline(never)
private func prop_exponent<T: Arbitrary & FloatingPoint>(_: T.Type) {
...
// @inline(never)
private func prop_floatingPointClass<T: Arbitrary & FloatingPoint>(_: T.Type) {
...
// @inline(never)
private func prop_isCanonical<T: Arbitrary & FloatingPoint>(_: T.Type) {
...
// @inline(never)
private func prop_isFinite<T: Arbitrary & FloatingPoint>(_: T.Type) {
...
// @inline(never)
private func prop_isInfinite<T: Arbitrary & FloatingPoint>(_: T.Type) {
...
// @inline(never)
private func prop_isNaN<T: Arbitrary & FloatingPoint>(_: T.Type) {
...
// @inline(never)
private func prop_isSignalingNaN<T: Arbitrary & FloatingPoint>(_: T.Type) {
...
// @inline(never)
private func prop_isNormal<T: Arbitrary & FloatingPoint>(_: T.Type) {
...
// @inline(never)
private func prop_isSubnormal<T: Arbitrary & FloatingPoint>(_: T.Type) {
...
// @inline(never)
private func prop_isZero<T: Arbitrary & FloatingPoint>(_: T.Type) {
...
// @inline(never)
private func prop_nextDown<T: Arbitrary & FloatingPoint>(_: T.Type) {
...
// @inline(never)
private func prop_nextUp<T: Arbitrary & FloatingPoint>(_: T.Type) {
...
// @inline(never)
private func prop_sign<T: Arbitrary & FloatingPoint>(_: T.Type) {
...
// @inline(never)
private func prop_significand<T: Arbitrary & FloatingPoint>(_: T.Type) {
...
// @inline(never)
private func prop_ulp<T: Arbitrary & FloatingPoint>(_: T.Type) {
...
// @inline(never)
private func prop_rounded<T: Arbitrary & FloatingPoint>(_: T.Type) {
...
// Not working ):
// @inline(never)
private func prop_roundedWithRoundingRule<T: Arbitrary & FloatingPoint>(_: T.Type) {
...
// @inline(never)
private func prop_floor<T: Arbitrary & FloatingPoint>(_: T.Type) {
...
// @inline(never)
private func prop_ceiling<T: Arbitrary & FloatingPoint>(_: T.Type) {
...
// @inline(never)
private func prop_truncate<T: Arbitrary & FloatingPoint>(_: T.Type) {
...
// @inline(never)
private func prop_pow<T: Arbitrary & Similar & ElementaryFunctions>(_: T.Type) {
...
// @inline(never)
private func prop_powi<T: Arbitrary & Similar & ElementaryFunctions>(_: T.Type) {
...
// @inline(never)
private func prop_sqrt<T: Arbitrary & Similar & RandomType & FloatingPoint & ElementaryFunctions>(_: T.Type) {
...
// @inline(never)
private func prop_reciprocal<T: Arbitrary & Similar & RandomType & AlgebraicField>(_: T.Type) {
...
// @inline(never)
private func prop_exp<T: Arbitrary & Similar & ElementaryFunctions>(_: T.Type) {
...
// @inline(never)
private func prop_exp2<T: Arbitrary & Similar & RealFunctions>(_: T.Type) {
...
// @inline(never)
private func prop_exp10<T: Arbitrary & Similar & RealFunctions>(_: T.Type) {
...
// @inline(never)
private func prop_expMinusOne<T: Arbitrary & Similar & ElementaryFunctions>(_: T.Type) {
...
// @inline(never)
private func prop_log<T: Arbitrary & Similar & RandomType & FloatingPoint & ElementaryFunctions>(_: T.Type) {
...
// @inline(never)
private func prop_log2<T: Arbitrary & Similar & RandomType & FloatingPoint & RealFunctions>(_: T.Type) {
    let gen = Gen.sized { size in Gen.choose((T(0).nextUp, T(size))) }
...
// @inline(never)
private func prop_log10<T: Arbitrary & Similar & RandomType & FloatingPoint & RealFunctions>(_: T.Type) {
    let gen = Gen.sized { size in Gen.choose((T(0).nextUp, T(size))) }
...
// @inline(never)
private func prop_logOnePlus<T: Arbitrary & Similar & RandomType & FloatingPoint & ElementaryFunctions>(_: T.Type) {
...
// @inline(never)
private func prop_sin<T: Arbitrary & Similar & ElementaryFunctions>(_: T.Type) {
...
// @inline(never)
private func prop_cos<T: Arbitrary & Similar & ElementaryFunctions>(_: T.Type) {
...
// @inline(never)
private func prop_tan<T: Arbitrary & Similar & FloatingPoint & ElementaryFunctions>(_: T.Type) {
    let gen = T.arbitrary.suchThat { !($0 ~~~ 0) }
...
// @inline(never)
private func prop_asin<T: Arbitrary & Similar & RandomType & FloatingPoint & ElementaryFunctions>(_: T.Type) {
...
// @inline(never)
private func prop_acos<T: Arbitrary & Similar & RandomType & FloatingPoint & ElementaryFunctions>(_: T.Type) {
    let gen = Gen.choose((T(-1), T(1)))
...
// @inline(never)
private func prop_atan<T: Arbitrary & Similar & FloatingPoint & ElementaryFunctions>(_: T.Type) {
...
// @inline(never)
private func prop_sinh<T: Arbitrary & Similar & ElementaryFunctions>(_: T.Type) {
...
// @inline(never)
private func prop_cosh<T: Arbitrary & Similar & ElementaryFunctions>(_: T.Type) {
...
// @inline(never)
private func prop_tanh<T: Arbitrary & Similar & ElementaryFunctions>(_: T.Type) {
...
// @inline(never)
private func prop_asinh<T: Arbitrary & Similar & ElementaryFunctions>(_: T.Type) {
...
// @inline(never)
private func prop_acosh<T: Arbitrary & Similar & RandomType & FloatingPoint & ElementaryFunctions>(_: T.Type) {
...
// @inline(never)
private func prop_atanh<T: Arbitrary & Similar & RandomType & FloatingPoint & ElementaryFunctions>(_: T.Type) {
    let gen = Gen.choose((T(-1), T(1)))
...
// @inline(never)
private func prop_atan2<T: Arbitrary & Similar & RealFunctions>(_: T.Type) {
...
// @inline(never)
private func prop_erf<T: Arbitrary & Similar & RealFunctions>(_: T.Type) {
...
// @inline(never)
private func prop_erfc<T: Arbitrary & Similar & RealFunctions>(_: T.Type) {
...
// @inline(never)
private func prop_gamma<T: Arbitrary & Similar & RealFunctions>(_: T.Type) {
...
// @inline(never)
private func prop_logGamma<T: Arbitrary & Similar & RealFunctions>(_: T.Type) {
...
// @inline(never)
private func prop_hypot<T: Arbitrary & Similar & RealFunctions>(_: T.Type) {
