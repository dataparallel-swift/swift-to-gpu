...
@Suite("Stencil") struct Stencil {
    ...
    @Suite("Float32") struct Float32Tests {
        ...
        // @Test("adjacent_difference<Float32>", .bug(id: "86b6vhbg7")) func test_adjacent_difference() { prop_adjacent_difference(Float32.self) }
...
private func prop_finite_difference<T: Arbitrary & AdditiveArithmetic & Similar>(_ proxy: T.Type) {
    @inline(never)
...
private func prop_laplace1D<T: Numeric & Arbitrary & Similar>(_ proxy: T.Type) {
